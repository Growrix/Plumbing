...
This document helps new engineers and AI-assisted contributors ramp into the current project without breaking core business rules.
...
- Confirm which role surfaces exist in the current project before making behavior changes.
