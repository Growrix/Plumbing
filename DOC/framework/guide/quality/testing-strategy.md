...
This document defines the end-to-end testing approach for the current project. Where the platform includes sensitive workflows around roles, payments, queue ordering, delivery, files, or maintenance, testing must protect business rules instead of only UI behavior.
