...
This document defines a canonical example entity model for the current project. Keep only the tables and relationships that apply to the active product scope.
