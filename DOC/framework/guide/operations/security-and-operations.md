...
This document establishes the operational and security baseline for the current project. If the product handles user identities, payment events, private files, internal-only workflows, or customer communications, operational discipline must exist from the first release.
