...
The target application should be built as a modular platform with strong security boundaries, reliable workflow integrity, auditable business flows, and a clear separation between public surfaces and restricted operational dashboards.

## Target Architecture

### Experience Layer

- Public website for marketing, intake flows, catalog or content surfaces, reviews, and the public AI assistant.
...
- OpenAI-compatible provider for the AI assistant.
