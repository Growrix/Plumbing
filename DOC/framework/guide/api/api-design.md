...
This document defines API standards for the current project. It covers route design, auth, request and response shape, webhook handling, realtime contracts, and module-specific endpoint groups.
