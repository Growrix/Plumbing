...
This document defines the backend architecture for the current project. It translates the platform model into server-side boundaries, integration strategy, and operational expectations.
