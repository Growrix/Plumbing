...
This document defines critical backend rules for queue-like flows, payments, and third-party integration safety when those modules exist in the current project.
