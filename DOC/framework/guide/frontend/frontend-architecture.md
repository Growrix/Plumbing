...
This document defines the frontend architecture for the current project. It exists to keep the public site and any privileged dashboards coherent while preventing privilege leakage, duplicated logic, and UI-driven business rules.
